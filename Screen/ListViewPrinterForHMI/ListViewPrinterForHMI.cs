...
namespace ListViewPrinterForHMI //ListViewPrinterDemo
{
    public partial class ListViewPrinterForHMI : IronPanel.InformationPanel   //Form
    {
        public ListViewPrinterForHMI()
        {
            InitializeComponent();
        }
        ...
        private void LoadXmlDataIntoList()
        {
            ...
            try {
                ...
                //string tablename = "LOG_GAS";

                string db_pathrootname;
                string db_filename_Header = "DATALOG-EEME-M1";
                string fullFilename;
                ...
                LoadTableIntoList(this.listView1, ds.Tables[tablename]);
            } catch (Exception){ // ex) {
