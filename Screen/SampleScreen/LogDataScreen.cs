...
{
    public partial class LogDataScreen : IronPanel.InformationPanel
    {       
        ...
        private void LogDataScreen_Load(Object sender, EventArgs e)
        {
            ...
            selListViewC1.ListViewItem(dt, "Log_Config_LV.xml", this.ProjectPath);
            selGraphViewC1.GraphViewItem(dt, "Log_Config.xml", this.ProjectPath);
        ...
        private DataTable Get_Data()
        {
            ...
            try
            {
                ...
                strQuery = " SELECT " + str_group_format + " AS 작업일시, " +
                           ...
                           " AVG(타워온도설정값_PLC) AS 타워온도설정값_PLC, AVG(타워온도설정값) AS 타워온도설정값, " +
                           " AVG(타워온도_PLC) AS 타워온도_PLC, AVG(타워온도값) AS 타워온도값, " +
                           " AVG(용탕온도설정값_PLC) AS 용탕온도설정값_PLC, AVG(용탕온도설정값) AS 용탕온도설정값, " +
                           " AVG(용탕온도_PLC) AS 용탕온도_PLC, AVG(용탕온도값) AS 용탕온도값 " +
                ...
                //    // 검색조건 직전의 분값
                //    double acc_electric_before=0;
                //    double acc_gas_before=0;
