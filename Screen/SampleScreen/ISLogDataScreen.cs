...
{
    public partial class ISLogDataScreen : IronPanel.InformationPanel
    {      
        ...
        private void LogDataScreen_Load(Object sender, EventArgs e)
        {
            ...
            selListViewC1.ListViewItem(dt, "ISLog_Config_LV.xml", this.ProjectPath);
            selGraphViewC1.GraphViewItem(dt, "ISLog_Config.xml", this.ProjectPath);
