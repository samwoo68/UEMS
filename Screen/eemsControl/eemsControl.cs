...
{
    public partial class eemsControl : IronControls.BaseControl
    {
        ...
        public override void UpdateValue(int notificationID, object[] values)
        {
            ...
            try
            {
                ...
                {
                    if (b_data) pB_heater4.Visible = true;
                ...
                //else if (index == 9) // Input10 : furnace_full
                //{
                //    if (b_data) pB_furnace.Visible = true;
                //    else pB_furnace.Visible = false;
                //}
